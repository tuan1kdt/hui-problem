...
// RunCalculate is PTKU Step 0: one sequential pass counting lines (DBSize), parsing item ids for MaxID,
// and summing declared transaction utilities (diagnostic; same semantics as TKU DatabaseInfo).
